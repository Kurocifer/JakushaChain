...
public class JakushaChain {
    ...
    public static void main(String[] args) {
        ...
        genesisTransaction.outputs.add(new TransactionOutput(genesisTransaction.getRecipient(), genesisTransaction.value, genesisTransaction.getTransactionId()));
    ...
    public static Boolean isChainValid() {
        ...
        tempUTXOs.put(genesisTransaction.outputs.getFirst().getId(), genesisTransaction.outputs.getFirst());
